...
class Decoder(nn.Module):
    ...
    def forward(self, mixture_w, est_mask, mixture):
        ...
        residual = mixture - est_source
        return est_source, residual
...
if __name__ == "__main__":
    ...
    for i in range(I):
        ...
        mixture_w = encoder(residual)
        print('mixture', residual)
        ...
        est_source, residual = decoder(mixture_w, est_mask, mixture)
